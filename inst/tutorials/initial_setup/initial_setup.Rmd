...
This is a demo tutorial quite entirely taken from [source code](https://github.com/rstudio/learnr/tree/main/inst/tutorials/ex-setup-r/ex-setup-r.Rmd) that made it. 

I have just slightly modified the original content of the code to adapt it for my specific purposes (thanks again to Rstudio community for the great gift).
