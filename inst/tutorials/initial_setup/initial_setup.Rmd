...
description: >
  Learn how to set up R, RStudio and install R packages from CRAN
---
...
## Welcoming and granting

This is a demo tutorial quite entirely taken from the [source code](https://github.com/rstudio/learnr/tree/main/inst/tutorials/ex-setup-r/ex-setup-r.Rmd) that made it. 

I have just slightly modified its original content to adapt it for my specific purposes (thanks again to Rstudio community for this great 'free lunch').
...
question("Check all that you have NOT done:",
  ...
  type = "multiple",
  incorrect = "This tutorial is here to help you in the R initial set up!"
)
```
...
Short instructions at the following [video](https://vimeo.com/203516510)

This [cheatsheet](https://github.com/rstudio/cheatsheets/blob/main/base-r.pdf) gives you a quick reference to some base R features.
...
quiz(caption = "Quiz - Install R",
  question("Is R free to download and use?",
    ...
    answer("No.", message = "R is free _and_ open source, which means that anyone can read, use, and copy the source code of the R language.")
  ),
...
What does that mean? Well, if you think of R as a language, which it is, you can think of RStudio as a program that helps you write and work in the language. 

RStudio makes programming in R much easier and I strongly suggest that you use it!

This [link](https://vimeo.com/203516968) explains how to install RStudio.

This [cheatsheet](https://raw.githubusercontent.com/rstudio/cheatsheets/main/rstudio-ide.pdf) gives you a quick reference to main features.
...
A short video [here](https://vimeo.com/203516241).
